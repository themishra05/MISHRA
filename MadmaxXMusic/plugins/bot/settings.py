...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
     InputMediaVideo("https://te.legra.ph/file/b304c4720d0b94a18d533.mp4", has_spoiler=True),
...
async def support(client, CallbackQuery, _):
    await CallbackQuery.edit_message_text(
        text="๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ʜᴇʟᴩ ᴀɴᴅ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.\n\n\nɪғ ʏᴏᴜ ғᴏᴜɴᴅ ᴀɴʏ ʙᴜɢ ɪɴ ‌ ๛ʜ ᴇ ᴇ ɴ ᴀ ♡゙ ᴏʀ ɪғ ʏᴏᴜ ᴡᴀɴɴᴀ ɢɪᴠᴇ ғᴇᴇᴅʙᴀᴄᴋ ᴀʙᴏᴜᴛ ᴛʜᴇ ‌ ๛ʜ ᴇ ᴇ ɴ ᴀ ♡゙, ᴩʟᴇᴀsᴇ ʀᴇᴩᴏʀᴛ ɪᴛ ᴀᴛ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ.",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="ᴄʜᴀɴɴᴇʟ", url="https://t.me/dpz_hub_05"
                    ),

                    InlineKeyboardButton(
                        text="sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ", url="https://t.me/friendssquadron"
                    ),
                    
                ],
                [
                    InlineKeyboardButton(
                        text="ᴅᴇᴠᴇʟᴏᴘᴇʀ", url="https://t.me/About_SAII/10"
                    ),

                    InlineKeyboardButton(
                        text="sᴜᴘᴘᴏʀᴛ", url="https://t.me/friendssquadron"
                    ),
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://telegra.ph/file/b6b38b43c6d322f3b7e08.mp4", has_spoiler=True, caption="✿ ʜ ᴇ ᴇ ɴ ᴀ ✿ ɪ ʟᴏᴠᴇ ʏᴏᴜ 💝🥵✨"),
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
